#ifndef BRE_APP_DEMO_MANUAL_SUBMISSION_TRIGGER_REGISTRY_MQH
#define BRE_APP_DEMO_MANUAL_SUBMISSION_TRIGGER_REGISTRY_MQH

class CDemoManualSubmissionTriggerRegistry
  {
private:
