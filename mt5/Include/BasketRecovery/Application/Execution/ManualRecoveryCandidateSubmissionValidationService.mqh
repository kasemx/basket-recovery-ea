#ifndef BRE_APP_MAN_RC_SUBMIT_VALIDATION_SVC_MQH
#define BRE_APP_MAN_RC_SUBMIT_VALIDATION_SVC_MQH
...
public:
   ...
   void              Configure(const CDemoExecutionAuthorizationConfig &config,
                               CManualRecoveryCandidateSubmissionService *service,
   ...
   CDemoManualSubmissionResult TryProcessManualRecoverySubmission(const string candidateId,
     ...
     {
      if(!IsManualRecoveryRouteEnabled())
      ...
      return m_service.TrySubmitRecoveryCandidate(candidateId,
                                                  authorizationToken,
                                                  triggerToken,
                                                  basket,
                                                  quote,
