#ifndef BRE_APP_MANUAL_RECOVERY_CANDIDATE_TRIGGER_REGISTRY_MQH
#define BRE_APP_MANUAL_RECOVERY_CANDIDATE_TRIGGER_REGISTRY_MQH

class CManualRecoveryCandidateTriggerRegistry
  {
private:
