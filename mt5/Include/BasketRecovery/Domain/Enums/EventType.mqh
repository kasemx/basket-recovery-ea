...
enum ENUM_BRE_EVENT_TYPE
  {
   ...
   BRE_EVENT_BREAK_EVEN_CANDIDATE_AVAILABLE,
   BRE_EVENT_BREAK_EVEN_CANDIDATE_BLOCKED,
   BRE_EVENT_BREAK_EVEN_STOP_PRICE_INVALID,
   BRE_EVENT_BREAK_EVEN_MODIFICATION_DRY_RUN_READY,
   BRE_EVENT_BREAK_EVEN_MODIFICATION_BLOCKED,
   BRE_EVENT_BREAK_EVEN_MODIFICATION_NO_CHANGE,
   BRE_EVENT_BREAK_EVEN_MODIFICATION_INVALID
  };
      ...
      switch(type)
        {
         ...
         case BRE_EVENT_BREAK_EVEN_EVALUATED: return "BreakEvenEvaluated";
         case BRE_EVENT_BREAK_EVEN_CANDIDATE_AVAILABLE: return "BreakEvenCandidateAvailable";
         case BRE_EVENT_BREAK_EVEN_CANDIDATE_BLOCKED: return "BreakEvenCandidateBlocked";
         case BRE_EVENT_BREAK_EVEN_STOP_PRICE_INVALID: return "BreakEvenStopPriceInvalid";
         case BRE_EVENT_BREAK_EVEN_MODIFICATION_DRY_RUN_READY: return "BreakEvenModificationDryRunReady";
         case BRE_EVENT_BREAK_EVEN_MODIFICATION_BLOCKED: return "BreakEvenModificationBlocked";
         case BRE_EVENT_BREAK_EVEN_MODIFICATION_NO_CHANGE: return "BreakEvenModificationNoChange";
         case BRE_EVENT_BREAK_EVEN_MODIFICATION_INVALID: return "BreakEvenModificationInvalid";
         default: return "None";
        }
     }
