#ifndef BRE_DOM_EXECUTION_ZONE_EXPANSION_MODE_MQH
#define BRE_DOM_EXECUTION_ZONE_EXPANSION_MODE_MQH
...
enum ENUM_BRE_PROFIT_LEVEL_SOURCE
  {
   ...
   BRE_PROFIT_LEVEL_SOURCE_FLOATING_PROFIT_MONEY,
   BRE_PROFIT_LEVEL_SOURCE_FLOATING_PROFIT_PCT_TARGET_RISK,
   BRE_PROFIT_LEVEL_SOURCE_FLOATING_PROFIT_PCT_EQUITY
  };
   ...
   static ENUM_BRE_PROFIT_LEVEL_SOURCE FromString(const string value)
     {
      ...
      if(value=="FLOATING_PROFIT_MONEY")
         return BRE_PROFIT_LEVEL_SOURCE_FLOATING_PROFIT_MONEY;
      if(value=="FLOATING_PROFIT_PCT_TARGET_RISK")
         return BRE_PROFIT_LEVEL_SOURCE_FLOATING_PROFIT_PCT_TARGET_RISK;
      if(value=="FLOATING_PROFIT_PCT_EQUITY")
         return BRE_PROFIT_LEVEL_SOURCE_FLOATING_PROFIT_PCT_EQUITY;
