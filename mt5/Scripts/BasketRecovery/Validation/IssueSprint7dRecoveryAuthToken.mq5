...
#property description "Sprint 7D: issue manual recovery authorization token from live candidate artifact."
...
void OnStart(void)
  {
   string reportRel="BasketRecovery/validation/sprint-7d-auth-result.txt";
   ...
   string volume=ReadArtifactValue("proposed_volume");
